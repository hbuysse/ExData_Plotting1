...
#graph1
plot(hpc$DateTime, hpc$Global_active_power, type="n",xlab="Days", ylab="Global Active Power") 
lines(hpc$DateTime, hpc$Global_active_power)
#graph2
plot(hpc$DateTime, hpc$Voltage, type="n",xlab="Days", ylab="Voltage") 
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),lwd=c(2.5,2.5,2.5),col=c("blue","red","green"), text.font=1,pch=1, pt.cex = 1)
par(op)
#graph4
plot(hpc$DateTime, hpc$Global_reactive_power, type="n",ylim=c(0.0,0.5), xlab="Days", ylab="Global_reactive_power") 
